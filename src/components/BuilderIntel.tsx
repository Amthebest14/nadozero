    ...
    >
      ...
      <div className="grid gap-3.5 border-b border-ink-700/50 p-6 sm:grid-cols-3">
        <div className="rounded-xl border border-[--color-down]/25 bg-[--color-down]/[0.06] px-4 py-3.5">
          ...
          <div className="tnum font-display mt-1 text-[26px] font-semibold text-[--color-down]">
            {pct(100 - routedShare)}
          </div>
        ...
        <div className="rounded-xl border border-ink-700/60 bg-ink-850/50 px-4 py-3.5">
          ...
          <div className="tnum font-display mt-1 text-[26px] font-semibold text-slate-100">{pct(routedShare)}</div>
          <div className="mt-0.5 text-[11px] text-slate-500">
        ...
        <div className="rounded-xl border border-mint-500/25 bg-mint-500/[0.07] px-4 py-3.5">
          ...
          <div className="tnum font-display mt-1 text-[26px] font-semibold text-mint-300">
            {named.length ? pct((named[0].volume / totalVolume) * 100, 2) : '—'}
          </div>
          <div className="mt-0.5 text-[11px] text-slate-500">no single builder owns this market yet</div>
        </div>
      </div>
      ...
      <p className="border-t border-ink-700/50 px-6 py-3.5 text-[11px] leading-relaxed text-slate-600">
